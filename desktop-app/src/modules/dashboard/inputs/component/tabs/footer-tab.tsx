...
interface FooterTabProps {
  settings: InputsSettings["footer"];
  toggleFeature: (feature: FeatureKey<"footer">) => void;
}

export const FooterTab = ({ settings, toggleFeature }: FooterTabProps) => {
  const options = [
    ...
    { title: "Last lap time", key: "lastLapTime" as const },
    {
      ...
      key: "lastLapTimeCalculated" as const,
    },
    ...
    { title: "Lap delta session best", key: "lapDeltaSessionBest" as const },
    {
      ...
      key: "lapDeltaSessionOptimal" as const,
    },
    ...
    { title: "Pit time loss beta", key: "pitTimeLossBeta" as const },
    {
      ...
      key: "windDirectionForDriver" as const,
    },
    {
      title: "Predicted position after pit stop",
      key: "predictedPositionAfterPitStop" as const,
    },
